...
import com.jujutsu.jujutsucraftaddon.network.AltarMessageTwo;
...
public class TodoScreen extends Screen {
    ...
    private List<AltarOption> getOptions() {
        ...
        options.add(new AltarOption("Boogie Woogie"));
        options.add(new AltarOption("Quick Attack"));
        options.add(new AltarOption("Swap"));
        options.add(new AltarOption("Itadori"));
        options.add(new AltarOption("Vibraslap"));
        options.add(new AltarOption("Swap Team Attack"));
        options.add(new AltarOption("Boogie Woogie Deflect"));
        return options;
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (this.hovered >= 0 && !this.selected) {
            this.selected = true;
            JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new AltarMessageTwo(this.hovered));
