...
import com.jujutsu.jujutsucraftaddon.network.AltarMessageMahoraga;
...
public class MahoragaScreen extends Screen {
    ...
    private List<AltarOption> getOptions() {
        ...
        options.add(new AltarOption("Mahoraga: World Slash"));
        options.add(new AltarOption("Mahoraga: Defensive"));
        options.add(new AltarOption("Mahoraga: Offensive"));
        return options;
    }
