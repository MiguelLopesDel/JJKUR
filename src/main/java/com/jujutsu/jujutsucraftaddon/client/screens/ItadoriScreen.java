...
import com.jujutsu.jujutsucraftaddon.network.AltarMessageItadori;
...
public class ItadoriScreen extends Screen {
    ...
    private List<AltarOption> getOptions() {
        ...
        options.add(new AltarOption("Strong Attack"));
        options.add(new AltarOption("Barrage Attack"));
        options.add(new AltarOption("Run Attack"));
        options.add(new AltarOption("Jump Attack"));
        options.add(new AltarOption("Piercing Blood"));
        options.add(new AltarOption("Soul Dismantle"));
        options.add(new AltarOption("Soul Cleave"));
        options.add(new AltarOption("Soul Cleave - SpiderWeb"));
        options.add(new AltarOption("Itadori Shrine"));
        return options;
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (this.hovered >= 0 && !this.selected) {
            this.selected = true;
            JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new AltarMessageItadori(this.hovered));
