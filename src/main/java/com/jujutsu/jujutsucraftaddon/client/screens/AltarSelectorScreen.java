...
import com.jujutsu.jujutsucraftaddon.network.AltarMessage;
...
public class AltarSelectorScreen extends Screen {
    ...
    private List<AltarOption> getOptions() {
        ...
        options.add(new AltarOption("Summon Rika"));
        options.add(new AltarOption("Quick Attack"));
        options.add(new AltarOption("Partial Rika"));
        options.add(new AltarOption("Copy CT"));
        options.add(new AltarOption("Cursed Weapon Storage"));
        options.add(new AltarOption("Pure Love"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < currentOptions.size(); i++) {
            ...
            int color = this.hovered == i ? toRGB24(255, 255, 255, 150) : toRGB24(255, 191, 253, 150);
