...
public class JujutsucraftaddonModGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanValue> JJKU_OP_SUKUNA_METRICS = GameRules.register("jjkuOPSukunaMetrics", GameRules.Category.MISC, GameRules.BooleanValue.create(false));
    public static final GameRules.Key<GameRules.BooleanValue> JJKU_SHOW_MARKS_TO_OTHERS = GameRules.register("jjkuShowSukunaMarksToOthers", GameRules.Category.MISC, GameRules.BooleanValue.create(true));
}
